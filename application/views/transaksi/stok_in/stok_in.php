	...
	<div class="content">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title"> Data Stok In </h3>
				<?php if($this->fungsi->user_login()->level != 3 ) { ?> 
				<div class="pull-right">
					<a href="<?=site_url('stok_in/add')?>" class="btn btn-primary">
						<i class="fa fa-plus"></i> Add Stok In
					</a>
				</div>
				<?php } ?>
			</div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center" width="150px">
								...
								<?php if($this->fungsi->user_login()->level != 3 ) { ?> 
								<a href="<?=site_url('stok_in/del/'.$data->id_stok.'/'.$data->id_bahan)?>" onclick="return confirm('Apakah anda yakin untuk menghapus data ini?')" class="btn btn-danger btn-xs">
