	...
	<div class="content">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title"><i class="fa fa-plus"></i> Add Stok In </h3>
				<div class="pull-right">
					<a href="<?=site_url('stok_in')?>" class="btn btn-warning">
			...
			<div class="box-body">
				...
				<?php //echo validation_errors(); ?>
						<form action="" method="post">
							...
							<div class="row">
							<div class="form-group col-md-6 col-md-offset-1 <?=form_error('total') ? 'has-error' : null?>">
