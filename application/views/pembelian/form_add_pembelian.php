	...
	<div class="content">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title"><i class="fa fa-plus"></i> Add pembelian </h3>
				<div class="pull-right">
					<a href="<?=site_url('pembelian')?>" class="btn btn-warning">
			...
			<div class="box-body">
				...
				<?php //echo validation_errors(); ?>
						<form action="proses" method="post">
							...
							<div>
								<label for="nama"> Cari Bahan : </label>
							</div>
							<div class="form-group input-group <?=form_error('nama') ? 'has-error' : null?>">
									...
									<input type="text" name="nama" id="nama" class="form-control" placeholder="Cari Bahan" readonly required>
							...
							<div class="form-group col-md-6 col-md-offset-1">
								...
								<select class="form-control" name="supplier">
									<option value=""> --PILIH-- </option>
										<?php foreach ($supplier as $sp => $data) {
							...
							<div class="form-group col-md-6 col-md-offset-1 <?=form_error('keterangan') ? 'has-error' : null?>">
								...
								<textarea type="text" name="keterangan" value="<?=set_value('keterangan')?>" class="form-control" rows="5" 
									placeholder="Ex : Kulakan / Tambahan / ..........."></textarea>
								<?=form_error('keterangan')?>
							</div>
							</div>

							<div class="form-group col-md-6 col-md-offset-3">
								<button type="submit" name="add_data" class="btn btn-success"><i class="fa fa-paper-plane"></i> Save </button>
								&nbsp;	
